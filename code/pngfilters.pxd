...
cdef class BaseFilter:
	...
	cdef void __undo_filter_sub(self, unsigned char[::1] scanline, unsigned char[::1] result)
	...
	cdef void __undo_filter_up(self, unsigned char[::1] scanline, unsigned char[::1] result)
	...
	cdef void __undo_filter_average(self, unsigned char[::1] scanline, unsigned char[::1] result)
	...
	cdef void __undo_filter_paeth(self, unsigned char[::1] scanline, unsigned char[::1] result)
